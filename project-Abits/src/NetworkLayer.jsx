...
const TextFileViewer = () => {
  ...
  const readFile = async () => {
    try {
      const response = await fetch('https://gist.githubusercontent.com/jammusaikiran/b4ed1cbbdd8deeec0501ec8142642b71/raw/2eeb69d21867277233dcfd5cdd8fc06fedd41dc8/network_layer.txt');
