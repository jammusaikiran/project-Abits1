...
const TextFileViewer = () => {
  ...
  const readFile = async () => {
    try {
      const response = await fetch('https://gist.githubusercontent.com/jammusaikiran/ed142f0d97068d0c081c78b7e8698995/raw/3bd35b121a3a76aa06fa0b5f2e950c216861cc2d/web_applications.txt');
