...
const TextFileViewer = () => {
  ...
  const readFile = async () => {
    try {
      const response = await fetch('https://gist.githubusercontent.com/jammusaikiran/97d10c50e3dcaacf450aa60d16fb6a37/raw/76393d08561ebb54f0795382362461c07d8d7b3d/mapping_port_scanning.txt');
