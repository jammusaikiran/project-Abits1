...
const TextFileViewer = () => {
  ...
  const readFile = async () => {
    try {
      const response = await fetch('https://gist.githubusercontent.com/jammusaikiran/163c61df7acc91473114206fdd675bcc/raw/797dd52c77b827b20eb5dbaa88d8d14c2146226b/incident_response.txt');
