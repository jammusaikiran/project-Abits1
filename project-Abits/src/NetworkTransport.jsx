...
const CyberCrime = () => {
  ...
  const readFile = async () => {
    try {
      const response = await fetch('https://gist.githubusercontent.com/jammusaikiran/72ff4c1fa4147993bb8c15910153b60d/raw/a69d30633dbb857bbbc9fe7f9da2a03b503ef5fd/network_transport.txt');
