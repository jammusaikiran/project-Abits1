...
const TextFileViewer = () => {
  ...
  const readFile = async () => {
    try {
      const response = await fetch('https://gist.githubusercontent.com/jammusaikiran/f3c3a21957272090f48411c2c8eec8fa/raw/d3115e143985389fae51103f276634ad328d5957/cybersecurity_dark_web.txt');
      // const response = await fetch('cybersecurity_darkweb.txt');
