...
const TextFileViewer = () => {
  ...
  const readFile = async () => {
    try {
      const response = await fetch('https://gist.githubusercontent.com/jammusaikiran/598ef78aa5457429df5e4570dbc7a11c/raw/a8a30a11cdab1bd82baebc2aa7533383a7e39a49/money.txt');
