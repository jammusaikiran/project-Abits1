...
const CyberCrime = () => {
  ...
  const readFile = async () => {
    try {
      const response = await fetch('https://gist.githubusercontent.com/jammusaikiran/187a3ddcbce408d5badfd675d74aedee/raw/f29aacad31a7b3ba3c098ec0d9a866e5767a3e9a/passwords.txt');
