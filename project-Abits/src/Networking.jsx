...
const TextFileViewer = () => {
  ...
  const readFile = async () => {
    try {
      const response = await fetch('https://gist.githubusercontent.com/jammusaikiran/18e1e29b2495a276ea3a8b152af4dc07/raw/4b69614a023ea77a6d1cc4b57e1b4b81c3a5037d/networking.txt');
