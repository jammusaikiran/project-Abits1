...
const TextFileViewer = () => {
  ...
  const readFile = async () => {
    try {
      const response = await fetch('https://gist.githubusercontent.com/jammusaikiran/e9bd44cc7e7091b508e681c08adf9b6b/raw/6d22de0c89360e6a8578a2513a9f880aa582fef7/networks_attacks.txt');
